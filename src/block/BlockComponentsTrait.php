...
trait BlockComponentsTrait
{
    ...
    protected function initComponent(string $texture): void {
        ...
        if($this instanceof Opaque){
            $this->addComponent(new MaterialComponent(MaterialComponent::TARGET_ALL, $texture, MaterialComponent::RENDER_METHOD_OPAQUE));
        } elseif($this instanceof Transparent){
            $this->addComponent(new MaterialComponent(MaterialComponent::TARGET_ALL, $texture, MaterialComponent::RENDER_METHOD_ALPHA_TEST, false));
        }
    }
}